...
export async function execute({resourceNames}: {resourceNames?: string[]}, agent: Agent): Promise<{
  ok: boolean;
  content: string;
  error?: string;
}> {
...
export const description = "Retrieves content from specified codebase resources (file trees, repo maps, or whole files).";

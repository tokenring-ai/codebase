...
export default class CodeBaseService extends Service {
 ...
 async* getMemories(registry) {
  ...
  const fileTreeResources = registry.resources.getResourcesByType(FileTreeResource);
  ...
  const wholeFileResources = registry.resources.getResourcesByType(WholeFileResource);
